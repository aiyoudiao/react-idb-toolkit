import{j as e}from"./index-DE9RcmX1.js";import{r as a}from"./index-Cqyox1Tj.js";import{a as V}from"./IndexedDBContext-DhpGHHG2.js";import{t as G,T as $,C as F,I as d,B as s}from"./toaster-DPEVdQf6.js";import"./index-D-LGQApf.js";const E={title:"Hooks/useIndexedDB",component:()=>null,parameters:{docs:{}}},l=()=>{window.alert=t=>{G({title:"Alert",description:t,duration:3e3})};const[n,m]=a.useState("myKey"),[r,x]=a.useState("Hello IndexedDB"),[h,y]=a.useState(),[g,p]=a.useState([]),[v,S]=a.useState([]),{loading:o,setItem:N,getItem:j,deleteItem:k,getAll:I,keys:f,clear:C}=V({dbName:"storybook-db",storeNames:["demoStore"]}),B=async()=>{await N("demoStore",n,r),alert(`✅ Set "${n}" = "${r}"`)},w=async()=>{const t=await j("demoStore",n);y(t)},A=async()=>{await k("demoStore",n),alert(`🗑️ Deleted "${n}"`)},K=async()=>{const t=await I("demoStore");S(t)},D=async()=>{const t=await f("demoStore");p(t)},b=async()=>{await C("demoStore"),alert("🧹 Cleared all entries")};return o?e.jsx("p",{className:"text-center",children:"Loading IndexedDB..."}):e.jsxs("div",{className:"flex items-center justify-center h-screen bg-gray-100",style:{height:"100vh"},children:[e.jsx($,{}),e.jsxs(F,{className:"p-6 space-y-6 max-w-xl mx-auto bg-white rounded-xl shadow-md",children:[e.jsx("h2",{className:"text-xl font-semibold text-center",children:"🧪 useIndexedDB Playground"}),e.jsxs("p",{className:"text-center",children:["Status: ",e.jsx("strong",{children:o?"Loading...":"Ready ✅"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx(d,{placeholder:"Key",value:n,onChange:t=>m(t.target.value)}),e.jsx(d,{placeholder:"Value",value:r,onChange:t=>x(t.target.value)}),e.jsxs("div",{className:"flex gap-2 flex-wrap",children:[e.jsx(s,{onClick:B,children:"💾 Set Item"}),e.jsx(s,{onClick:w,children:"🔍 Get Item"}),e.jsx(s,{onClick:A,children:"❌ Delete Item"}),e.jsx(s,{variant:"destructive",onClick:b,children:"🧹 Clear Store"})]})]}),e.jsxs("div",{className:"space-x-2 flex",children:[e.jsx(s,{onClick:K,children:"📦 Get All Values"}),e.jsx(s,{onClick:D,children:"🗂️ Get All Keys"})]}),e.jsxs("div",{className:"space-y-2 mt-6",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Fetched value:"})," ",e.jsx("span",{className:"text-blue-700",children:h??"(not found)"})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"All keys:"})," ",e.jsx("code",{className:"text-sm",children:JSON.stringify(g)})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"All values:"})," ",e.jsx("code",{className:"text-sm",children:JSON.stringify(v)})]})]})]})]})};l.__docgenInfo={description:"",methods:[],displayName:"Playground"};var c,i,u;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
...
}`,...(u=(i=l.parameters)==null?void 0:i.docs)==null?void 0:u.source}}};const H=["Playground"];export{l as Playground,H as __namedExportsOrder,E as default};
