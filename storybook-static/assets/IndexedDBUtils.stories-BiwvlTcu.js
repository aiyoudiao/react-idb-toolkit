import{j as e}from"./index-DE9RcmX1.js";import{r as a}from"./index-Cqyox1Tj.js";import{c as A,t as K,T as V,C as G,a as i,B as l}from"./toaster-qgGh5c_B.js";import"./index-D-LGQApf.js";let r=null;async function b(s){return r||(r=new A(s),await r.init()),r}function L(){if(!r)throw new Error("IndexedDB is not ready yet. Please call initIndexedDB() first.");return r}const F={title:"Utils/indexedDBUtils",component:()=>null,parameters:{docs:{}}};let t=null;const o=()=>{window.alert=n=>{K({title:"Alert",description:n,duration:3e3})};const[s,y]=a.useState("myKey"),[d,h]=a.useState("Hello IndexedDB"),[g,p]=a.useState(),[S,f]=a.useState([]),[v,N]=a.useState([]),[c,j]=a.useState(!0);a.useEffect(()=>{b({dbName:"storybook-db",storeNames:["demoStore"]}).then(()=>{t=L(),j(!1)})},[]);const B=async()=>{await(t==null?void 0:t.setItem("demoStore",s,d)),alert(`✅ Set "${s}" = "${d}"`)},I=async()=>{const n=await(t==null?void 0:t.getItem("demoStore",s));p(n)},w=async()=>{await(t==null?void 0:t.deleteItem("demoStore",s)),alert(`🗑️ Deleted "${s}"`)},C=async()=>{await(t==null?void 0:t.clear("demoStore")),alert("🧹 Cleared all entries")},k=async()=>{const n=await(t==null?void 0:t.keys("demoStore"));f(n)},D=async()=>{const n=await(t==null?void 0:t.getAll("demoStore"));N(n)};return c?e.jsx("p",{className:"text-center",children:"Loading IndexedDB..."}):e.jsxs("div",{className:"flex items-center justify-center h-screen bg-gray-100",children:[e.jsx(V,{}),e.jsxs(G,{className:"p-6 space-y-6 max-w-xl mx-auto bg-white rounded-xl shadow-md",children:[e.jsx("h2",{className:"text-xl font-semibold text-center",children:"🧪 indexedDBUtils Playground"}),e.jsxs("p",{className:"text-center",children:["Status: ",e.jsx("strong",{children:c?"Loading...":"Ready ✅"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx(i,{placeholder:"Key",value:s,onChange:n=>y(n.target.value)}),e.jsx(i,{placeholder:"Value",value:d,onChange:n=>h(n.target.value)}),e.jsxs("div",{className:"flex gap-2 flex-wrap",children:[e.jsx(l,{onClick:B,children:"💾 Set Item"}),e.jsx(l,{onClick:I,children:"🔍 Get Item"}),e.jsx(l,{onClick:w,children:"❌ Delete Item"}),e.jsx(l,{variant:"destructive",onClick:C,children:"🧹 Clear Store"})]})]}),e.jsxs("div",{className:"space-x-2 flex",children:[e.jsx(l,{onClick:D,children:"📦 Get All Values"}),e.jsx(l,{onClick:k,children:"🗂️ Get All Keys"})]}),e.jsxs("div",{className:"space-y-2 mt-6",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Fetched value:"})," ",e.jsx("span",{className:"text-blue-700",children:g??"(not found)"})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"All keys:"})," ",e.jsx("code",{className:"text-sm",children:JSON.stringify(S)})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"All values:"})," ",e.jsx("code",{className:"text-sm",children:JSON.stringify(v)})]})]})]})]})};o.__docgenInfo={description:"",methods:[],displayName:"Playground"};var u,m,x;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`() => {
...
}`,...(x=(m=o.parameters)==null?void 0:m.docs)==null?void 0:x.source}}};const O=["Playground"];export{o as Playground,O as __namedExportsOrder,F as default};
